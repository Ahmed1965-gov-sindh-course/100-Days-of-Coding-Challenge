...
// Muhammad Ahmed:  28.05.2024

//This is a program to print a message with name
let myName:string = "Muhammad Ahmed";
let myMessage:string = `Hello! Mr. ${myName} Would you like to learn some python today`
