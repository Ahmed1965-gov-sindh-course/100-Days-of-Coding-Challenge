...
*/
//creating a function which determine remainder of a number

function remainder(n:number, o:number):number{
    return n%o;
}
console.log(`The Remainder of number is : ${remainder(7,2)}`)
